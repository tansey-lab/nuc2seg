...
from nuc2seg.data import SegmentationResults, Nuc2SegDataset, ModelPredictions
...
def score_foreground_segmentation(
    ...
    foreground_mask = predictions.foreground > 0.5
    background_mask = predictions.foreground <= 0.5
