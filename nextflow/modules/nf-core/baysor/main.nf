process BAYSOR {
    ...
    def scale_arg = ("${meta.baysor_scale}" == null || "${meta.baysor_scale}" == "null") ? "" : "--scale ${meta.baysor_scale}"
    def scale_std_arg = ("${meta.baysor_scale_std}" == null || "${meta.baysor_scale_std}" == "null") ? "" : "--scale-std ${meta.baysor_scale_std}"
    def baysor_min_molecules_per_cell_arg = ("${meta.baysor_min_molecules_per_cell}" == null || "${meta.baysor_min_molecules_per_cell}" == "null") ? "" : "--min-molecules-per-cell ${meta.baysor_min_molecules_per_cell}"
    def prior_segmentation_confidence_arg = ("${meta.prior_segmentation_confidence}" == null || "${meta.prior_segmentation_confidence}" == "null") ? "" : "--prior-segmentation-confidence ${meta.prior_segmentation_confidence}"
    def baysor_n_clusters_arg = ("${meta.baysor_n_clusters}" == null || "${meta.baysor_n_clusters}" == "null") ? "" : "--n-clusters ${meta.baysor_n_clusters}"
