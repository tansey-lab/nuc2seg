...
uses a simple watershed algorithm that is not always accurate. nuc2seg solve the problem of cell body segmentation
by using the nucleus segmentation, along with the transcripts and rudimentary cell typing, to assign better cell body
segments.

nuc2seg is packaged as an nf-core standard pipeline. All standard nf-core pipeline features are available.
